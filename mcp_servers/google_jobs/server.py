...
# To Claude Desktop configuration, comment the above code and uncomment the following:
...
# server = Server("google-jobs-mcp-server")

# if SERPAPI_API_KEY:
#     serpapi_token_context.set(SERPAPI_API_KEY)
...
#             company_name = arguments.get("company_name")
#             if not company_name:
#                 return [types.TextContent(type="text", text="Error: company_name parameter is required")]
...
# async def main():
#     """main func to run the MCP server."""
#     # Initialize options
#     options = InitializationOptions(
#         server_name="google-jobs-mcp-server",
...
#     logger.info("Starting Google Jobs MCP Server...")
...
#       "command": "python",
#       "args": [
#         "path/klavis/mcp_servers/google_jobs/server.py"
#       ],
#       "env": {
#         "SERPAPI_API_KEY": "serapi_api_key_here"
#       }
#     }
#   }
# }
